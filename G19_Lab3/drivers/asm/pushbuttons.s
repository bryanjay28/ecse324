			...
			.edu PB_MASK, 0xFF200058
			.edu PB_EDGECAP, 0xFF20005C
			.global read_PD_data_ASM
...
PB_edgecap_is_pressed_ASM:		
			LDR R1, =PD_EDGECAP	// repeat the process as above except for PB_EDGECAP
			LDR R1, [R1]		
			AND R2, R2, R0
			CMP R2, R0			
			MOVEQ R0, #1		
...
PB_clear_edgecp_ASM:
			LDR R1, =PD_EDGECAP // load the address
...
enable_PB_INT_ASM:
			LDR R1, =PB_MASK	
			LDR R2, R0, #0xF	// we only want the last 4 numbers since there are b
